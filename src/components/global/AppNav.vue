  ...
  <v-app-bar absolute color="blue" height="fit-content">
    <v-container max-width="100%">
      <v-row class="d-flex justify-space-between align-center">
        ...
        <v-col cols="5">
          <div class="position-relative" style="width: 90%">
            <input
              class="px-6 py-2 bg-white border-rad"
              name="navSearch"
        ...
        <v-col cols="3">
          ...
          >
            <div class="available">
              <span>Available 24/77</span>
              <br />
              <strong>(053)636 809 20</strong>
            </div>
            <div class="wishlist d-flex flex-column align-center">
              <svg
                class="icon icon-wishlist"
                style="width: 28px; fill: #ffc354"
                viewBox="0 0 512 512"
              >
                <g>
                  <g>
        ...
        C482,254.358,413.255,312.939,309.193,401.614z"
              ...
              <span style="color: #ffc354">Wish Lists</span>
            </div>
            <div class="wishlist d-flex flex-column align-center">
              <svg
              ...
              <span style="color: #ffc354">Sign in</span>
            </div>
            <div
            ...
            >
              ...
              <span style="color: #ffc354">Cart</span>
            </div>
          </div>
        </v-col>
      </v-row>
      <v-row class="mt-8">
        ...
        <v-col></v-col>
        <v-col class="d-flex justify-end ga-5" cols="5">
          <div class="help d-flex align-center ga-3 text-white">
            <svg
              aria-hidden="false"
          ...
          <div
            id="language-list"
            class="lang d-flex align-center ga-3 text-white"
            style="cursor: pointer"
          >
            ...
            <v-menu activator="#language-list">
